                            ...
                            <div class="card box-shadow-sm">
                                ...
                                <div class="card-content collpase show">
                                    ...
                                    <div class="card-body card-dashboard text-center">
                                        <p class="text-dark">MASUKAN NIS/NISN DAN KLIK TOMBOL CEK</p>

                                        <br>
                                        <form @submit.prevent="submitSearch">

                                            <div class="form-group text-center">
                                                <input type="text" v-model="search" class="form-control" id="maxlength-position-inside" placeholder="NIS/NISN" maxlength="17" />
                                            </div>
                                            <br>
